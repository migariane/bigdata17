...
## Unit: microseconds
##                                             expr     min       lq     mean
##               fit1 <- lm(Hwt ~ Bwt, data = cats) 646.628 672.8640 739.4639
##           fit2 <- linmod(Hwt ~ Bwt, data = cats) 514.311 536.1520 604.3039
##  fit3 <- linmodEst(cbind(1, cats$Bwt), cats$Hwt)  99.370 118.0265 132.6574
##    median       uq      max neval cld
##  697.3575 770.9850 1325.828   100   c
##  550.2295 633.6295 1611.840   100  b 
##  127.0395 137.2735  262.125   100 a
\end{verbatim}
