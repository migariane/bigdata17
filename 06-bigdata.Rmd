...
Reading: http://www.parallelr.com/r-gpu-programming-for-all-with-gpur/
...
Let's launch an `Amazon Linux` instance (`t2.micro` free tier eligible) and configure a key pair.

File permissions: https://www.tutorialspoint.com/unix/unix-file-permission.htm
