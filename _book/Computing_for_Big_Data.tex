...
##       [32, 11] 8962 10253.0 11876.268 10727.5 11436.5  72681  1000
##      $carb[32] 4579  5919.5  7146.879  6374.5  6888.5 135047  1000
##  [[c(11, 32)]] 3814  4796.5  5646.803  5201.0  5638.5  86632  1000
##     [[11]][32] 3561  4543.0  5323.011  4907.5  5284.5  43629  1000
##       .subset2  205   280.0   404.527   326.5   395.0  11174  1000
\end{verbatim}
...
## Unit: microseconds
##                                             expr     min       lq     mean
##               fit1 <- lm(Hwt ~ Bwt, data = cats) 666.573 699.7115 820.9289
##           fit2 <- linmod(Hwt ~ Bwt, data = cats) 528.605 554.9735 615.7111
##  fit3 <- linmodEst(cbind(1, cats$Bwt), cats$Hwt)  96.846 120.2085 140.6272
##    median       uq      max neval
##  742.3940 847.2425 3636.144   100
##  586.8095 652.8445  927.836   100
##  134.1755 155.4200  312.654   100
\end{verbatim}
...
## Unit: microseconds
##   expr       min        lq       mean     median        uq       max neval
##  vacc0  2399.701  3612.383  4674.6925  4206.2740  4720.835 17692.829   100
##  vacc1  2091.525  2658.894  3519.8335  3091.9810  4024.894 10996.034   100
##  vacc2   106.483   166.242   646.9759   227.0705   712.890  7849.273   100
##  vacc3 14835.231 21244.273 24740.3021 23228.2650 27309.717 38817.280   100
\end{verbatim}
...
\begin{verbatim}
## function () 
## invisible(.Primitive(".Call")(<pointer: 0x10860fcc0>))
\end{verbatim}
...
\NormalTok{    H2O cluster total memory}\OperatorTok{:}\StringTok{   }\FloatTok{15.18}\NormalTok{ GB }
...
\section{Running a GLM model}\label{running-a-glm-model}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{h2ofit <-}\StringTok{ }\KeywordTok{h2o.glm}\NormalTok{(}\DataTypeTok{y =} \StringTok{"IsArrDelayed"}\NormalTok{, }\DataTypeTok{x =} \StringTok{"Distance"}\NormalTok{,}
                  \DataTypeTok{training_frame =}\NormalTok{ airlines_to_h2o,}
                  \DataTypeTok{standardize =} \OtherTok{FALSE}\NormalTok{,}
...
\begin{Highlighting}[]
\NormalTok{Coefficients}\OperatorTok{:}\StringTok{ }\NormalTok{glm coefficients}
\NormalTok{      names coefficients}
\DecValTok{1}\NormalTok{ Intercept     }\FloatTok{0.175590}
\DecValTok{2}\NormalTok{  Distance     }\FloatTok{0.000066}
\end{Highlighting}
\end{Shaded}
