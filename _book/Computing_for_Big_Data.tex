...
##       [32, 11] 8528 10091.5 11836.020 10555.5 11142.0 304845  1000
##      $carb[32] 4631  5830.5  7032.024  6288.0  6757.5 130665  1000
##  [[c(11, 32)]] 3717  4690.0  5574.615  5097.0  5486.5  99237  1000
##     [[11]][32] 3526  4459.0  5927.647  4798.0  5178.5 541368  1000
##       .subset2  205   266.0   364.643   311.5   375.0  10259  1000
\end{verbatim}
...
## Unit: microseconds
##                                             expr     min      lq     mean
##               fit1 <- lm(Hwt ~ Bwt, data = cats) 681.435 730.793 870.0019
##           fit2 <- linmod(Hwt ~ Bwt, data = cats) 586.509 612.982 730.2025
##  fit3 <- linmodEst(cbind(1, cats$Bwt), cats$Hwt)  98.976 115.449 145.0813
##    median      uq      max neval
##  763.1385 883.915 3196.983   100
##  633.5360 722.993 2055.521   100
##  133.0135 152.929  526.125   100
\end{verbatim}
...
## Unit: microseconds
##   expr       min        lq       mean     median        uq       max neval
##  vacc0  2398.783  3040.664  4115.0505  3491.9910  4482.053 13818.834   100
##  vacc1  2007.864  2319.678  3156.6179  2564.3795  3316.053  9295.554   100
##  vacc2   116.258   144.574   642.4547   201.9445   593.068  6529.062   100
##  vacc3 12307.463 17523.095 20489.5760 18782.4615 20904.978 35779.593   100
\end{verbatim}
...
\begin{verbatim}
## function () 
## invisible(.Primitive(".Call")(<pointer: 0x10864dcc0>))
\end{verbatim}
...
\subsection{\texorpdfstring{R and
\texttt{data.table}}{R and data.table}}\label{r-and-data.table}
...
\subsection{\texorpdfstring{\texttt{Spark}}{Spark}}\label{spark}
